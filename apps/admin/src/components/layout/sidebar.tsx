...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile menu button */}
      <div className="fixed top-0 left-0 z-40 flex h-16 w-full items-center justify-between border-b bg-background px-4 lg:hidden">
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-40 flex h-full w-64 flex-col border-r bg-background transition-transform lg:translate-x-0',
