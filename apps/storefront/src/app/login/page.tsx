    ...
    <div className="min-h-screen pt-20 pb-12 flex items-center justify-center bg-[#fafafa]">
      <div className="w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-[#777]">Welcome back</p>
        </div>

        {/* Form Card */}
        <div className="bg-white rounded-2xl shadow-sm border border-[#e5e5e5] p-8">
          <h1 className="text-2xl font-light tracking-tight mb-6">Sign In</h1>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-4 text-sm text-[#999]">or continue with</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-3 border border-[#e5e5e5] rounded-xl hover:bg-[#f9f9f9] transition-colors">
